...
import { Home, CreditCard, Users, Settings, Menu, X, LogOut, Bell, Search, Coins, Wallet, Building } from "lucide-react";
import { useToast } from "@/hooks/use-toast";
import { authService } from "@/services/authService";
import OrgLayoutWrapper from "./OrgLayoutWrapper";
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="fixed md:static top-0 left-0 right-0 z-50 bg-white border-b border-border px-2 sm:px-4 lg:px-6 h-16 flex items-center justify-between shadow-sm">
        <div className="flex items-center space-x-2 sm:space-x-4 flex-1">
          ...
          <Link to="/org-dashboard" className="flex items-center justify-start">
            <img 
        ...
        <div className="flex items-center space-x-1 sm:space-x-2 md:space-x-4">
          ...
          <div className="hidden md:flex items-center space-x-2">
            <div className="flex items-center space-x-2 bg-blue-50 p-2 rounded-lg border border-blue-200">
              ...
              <span className="text-xs font-medium text-blue-800">Organization</span>
            </div>
            <div className="text-right">
              <p className="text-xs sm:text-sm font-medium">{user?.name || "Org Admin"}</p>
      ...
      <div className="flex pt-16 md:pt-0">
        ...
        {/* Main Content with Organization Wrapper */}
