    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="flex">
        ...
        <aside
          ...
          } lg:translate-x-0 fixed lg:static inset-y-0 left-0 z-50 w-64 bg-white border-r border-border transition-transform duration-300 ease-in-out lg:transition-none shadow-lg lg:shadow-none`}
        >
