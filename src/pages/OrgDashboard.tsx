        ...
        <div className="py-4 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-gray-50 rounded-xl p-3">
              ...
              <p className="text-lg font-bold text-black">UGX {(dashboardData.totalCollections / 1000000).toFixed(1)}M</p>
              <p className="text-xs text-gray-500">+8.2%</p>
            </div>
            <div className="bg-gray-50 rounded-xl p-3">
              <div className="flex items-center gap-2 mb-2">
                <Wallet className="h-4 w-4 text-blue-600" />
                <span className="text-xs font-medium text-gray-700">Petty Cash</span>
              </div>
              <p className="text-lg font-bold text-black">UGX {(dashboardData.pettyCashBalance / 1000).toFixed(0)}K</p>
              <p className="text-xs text-gray-500">+5.3%</p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <Dialog open={sendToBankOpen} onOpenChange={setSendToBankOpen}>
              <DialogTrigger asChild>
                <button className="bg-blue-600 text-white rounded-xl p-4 text-left">
                  <Building className="h-5 w-5 mb-2" />
                  <p className="text-sm font-medium">Send to Bank</p>
                  <p className="text-xs opacity-80">Transfer funds</p>
                </button>
              </DialogTrigger>
            ...
            <Dialog open={withdrawOpen} onOpenChange={setWithdrawOpen}>
              <DialogTrigger asChild>
                <button className="bg-white border border-gray-200 rounded-xl p-4 text-left">
                  <Phone className="h-5 w-5 mb-2 text-blue-600" />
                  <p className="text-sm font-medium text-black">Withdraw</p>
                  <p className="text-xs text-gray-500">To mobile money</p>
                </button>
              </DialogTrigger>
              <DialogContent className="mx-4">
                <DialogHeader>
              ...
              <>
                <div className="bg-white border border-gray-100 rounded-xl p-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs text-blue-600 font-medium">{dashboardData.teamMetrics.activeStaff}/{dashboardData.teamMetrics.totalStaff}</span>
                  </div>
                ...
                <div className="bg-white border border-gray-100 rounded-xl p-3">
                  ...
                  <p className="text-lg font-bold text-black">Budget</p>
