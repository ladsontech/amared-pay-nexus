...
import { Plus, Search, Filter, Users, Building, Wallet } from "lucide-react";
...
const Organizations = () => {
  ...
  useEffect(() => {
    // Simulate fetching organizations from /organizations/
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Manage organizations and their wallet balances
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Total Wallet Balance</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold">
                ${organizations.reduce((sum, org) => sum + org.walletBalance, 0).toLocaleString()}
              </div>
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-medium">${org.walletBalance.toLocaleString()}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-muted-foreground flex items-center">
